...
def plot_temperature_vs_traffic(df):
    ...
    sns.lineplot(data=df, x='month', y='tavg', marker='o', label='Avg Temp (°C)', linewidth=2.5, color='orange')
    plt.fill_between(df['month'], df['tavg'], color='orange', alpha=0.3)
    plt.twinx()
    sns.lineplot(data=df, x='month', y='traffics', marker='s', linestyle='--', color='blue')
    plt.title('Average Temperature vs Traffic', fontsize=18)
    plt.xlabel('Month', fontsize=14)
    plt.ylabel('Traffic', fontsize=14)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    plt.legend(['Avg Temp (°C)', 'Traffic'], loc='upper left', fontsize=12)
    plt.show()

def plot_snowfall_vs_traffic(df):
    plt.figure(figsize=(12, 8))
    sns.lineplot(data=df, x='month', y='snow', marker='o', label='Avg Snowfall (mm)', linewidth=2.5, color='purple')
    plt.fill_between(df['month'], df['snow'], color='purple', alpha=0.3)
    plt.twinx()
    sns.lineplot(data=df, x='month', y='traffics', marker='s', linestyle='--', color='green')
    plt.title('Average Snowfall vs Traffic', fontsize=18)
    plt.xlabel('Month', fontsize=14)
    plt.ylabel('Traffic', fontsize=14)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    plt.legend(['Avg Snowfall (mm)', 'Traffic'], loc='upper left', fontsize=12)
    plt.show()

def plot_precipitation_vs_traffic(df):
    plt.figure(figsize=(12, 8))
    sns.lineplot(data=df, x='month', y='prcp', marker='o', label='Avg Precipitation (mm)', linewidth=2.5, color='blue')
    plt.fill_between(df['month'], df['prcp'], color='blue', alpha=0.3)
    plt.twinx()
    sns.lineplot(data=df, x='month', y='traffics', marker='s', linestyle='--', color='red')
    plt.title('Average Precipitation vs Traffic', fontsize=18)
    plt.xlabel('Month', fontsize=14)
    plt.ylabel('Traffic', fontsize=14)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    plt.legend(['Avg Precipitation (mm)', 'Traffic'], loc='upper left', fontsize=12)
    plt.show()

def plot_wind_speed_vs_traffic(df):
    plt.figure(figsize=(12, 8))
    sns.lineplot(data=df, x='month', y='wspd', marker='o', label='Avg Wind Speed (km/h)', linewidth=2.5, color='green')
    plt.fill_between(df['month'], df['wspd'], color='green', alpha=0.3)
    plt.twinx()
    sns.lineplot(data=df, x='month', y='traffics', marker='s', linestyle='--', color='orange')
    plt.title('Average Wind Speed vs Traffic', fontsize=18)
    plt.xlabel('Month', fontsize=14)
    plt.ylabel('Traffic', fontsize=14)
    plt.xticks(fontsize=12)
    plt.yticks(fontsize=12)
    plt.legend(['Avg Wind Speed (km/h)', 'Traffic'], loc='upper left', fontsize=12)
    plt.show()

def plot_season_vs_traffic(df):
    plt.figure(figsize=(12, 8))
    sns.boxplot(data=df, x='season', y='traffics', palette='Set3')
    sns.stripplot(data=df, x='season', y='traffics', color='black', alpha=0.6)
    plt.title('Season vs Traffic', fontsize=18)
...
def plot_all_factors_vs_traffic(df):
    ...
    ax1.set_ylabel('Traffic', color='gray', fontsize=14)
    sns.lineplot(data=df, x='month', y='traffics', marker='s', linestyle='-', color='gray', label='Traffic', ax=ax1)
    ax1.tick_params(axis='y', labelcolor='gray', labelsize=12)
    ax1.tick_params(axis='x', labelsize=12)

    ax2 = ax1.twinx()
    sns.lineplot(data=df, x='month', y='tavg', marker='o', label='Avg Temp (°C)', linewidth=2.5, color='red', ax=ax2)
    sns.lineplot(data=df, x='month', y='snow', marker='o', label='Avg Snowfall (mm)', linewidth=2.5, color='blue', ax=ax2)
    sns.lineplot(data=df, x='month', y='prcp', marker='o', label='Avg Precipitation (mm)', linewidth=2.5, color='purple', ax=ax2)
    sns.lineplot(data=df, x='month', y='wspd', marker='o', label='Avg Wind Speed (km/h)', linewidth=2.5, color='green', ax=ax2)
    ax2.set_ylabel('Avg Values', color='blue', fontsize=14)
    ax2.tick_params(axis='y', labelcolor='blue', labelsize=12)

    fig.tight_layout()
    plt.title('All Weather Factors vs Traffic', fontsize=18)

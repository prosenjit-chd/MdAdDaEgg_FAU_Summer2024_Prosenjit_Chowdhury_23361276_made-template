...
def plot_temperature_vs_traffic(df):
    ...
    sns.lineplot(data=df, x='month', y='tavg', marker='o', label='Avg Temp (°C)', linewidth=2.5, color='red')
    plt.twinx()
    sns.barplot(data=df, x='month', y='traffics', alpha=0.6, color='gray')
...
def plot_snowfall_vs_traffic(df):
    plt.figure(figsize=(12, 8))
    sns.lineplot(data=df, x='month', y='snow', marker='o', label='Avg Snowfall (mm)', linewidth=2.5, color='blue')
    plt.twinx()
    sns.barplot(data=df, x='month', y='traffics', alpha=0.6, color='gray')
...
def plot_precipitation_vs_traffic(df):
    plt.figure(figsize=(12, 8))
    sns.lineplot(data=df, x='month', y='prcp', marker='o', label='Avg Precipitation (mm)', linewidth=2.5, color='purple')
    plt.fill_between(df['month'], df['prcp'], color='purple', alpha=0.3)
    plt.twinx()
    sns.barplot(data=df, x='month', y='traffics', alpha=0.6, color='gray')
